...
clf = RandomForestClassifier(n_estimators = 10, max_features = "log2", min_samples_split = 12) # n_estimators = 10, max_features = "log2", min_samples_split = 12 (sometimes) gives acc=0.928
t0 = time()
